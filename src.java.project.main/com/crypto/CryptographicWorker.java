...
/**
 * Cryptographic worker interface
 *
 * @author Stefannel,  Jul 1, 2018
 */
public interface CryptographicWorker
{
    /**
    ...
    /**Get merkleRoot for the given blockchain transactions
     * @param bcTransactions the bc transactions
